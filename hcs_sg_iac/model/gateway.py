...
class CloudGateway(CloudReader, CloudWriter, Protocol):
    """What the CLI hands its handlers: one object filling both seams
    (the real SDK gateway, the in-memory fake)."""
