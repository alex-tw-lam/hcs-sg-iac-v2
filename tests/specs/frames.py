...
def _snapshot(
    ...
    d = {
        "sgs": [
            {"id": sid, "name": name, "description": ""} for sid, name in sgs
        ],
        "rules": {},
        "attached": {},
        "nics_by_ip": {
            ip: [{"port_id": port, "ip": ip, "vm_name": None}]
            for ip, port in nics
        },
    }
    for r in rules:
...
FRAMES: list = [
    ...
    Frame(
        ...
        1,
        "A1",
        "digit-leading name is valid",
        model_call="parse_group",
        model_input={"name": "1web", "members": []},
        expect_ok=True,
        expect_value=("1web", "", ()),
    ),
    Frame(
        ...
        1,
        "A1",
        "64-char name is the length boundary",
        model_call="parse_group",
        model_input={"name": "a" * 64, "members": []},
        expect_ok=True,
        expect_value=("a" * 64, "", ()),
    ),
    Frame(
        ...
        1,
        "A1",
        "trailing-hyphen name is valid",
        model_call="parse_group",
        model_input={"name": "web-", "members": []},
        expect_ok=True,
        expect_value=("web-", "", ()),
    ),
    Frame(
        ...
        1,
        "A1",
        "uppercase name is rejected with the regex",
        model_call="parse_group",
        model_input={"name": "Web", "members": []},
        expect_ok=False,
    ...
    Frame(
        ...
        1,
        "A1",
        "underscore name is valid (org naming dev_sg_iac_x_*)",
        model_call="parse_group",
        model_input={"name": "web_tier", "members": []},
        expect_ok=True,
        expect_value=("web_tier", "", ()),
    ),
    Frame(
        "NAME-02.b",
        1,
        "A1",
        "leading-hyphen name is rejected",
        model_call="parse_group",
        model_input={"name": "-web", "members": []},
        expect_ok=False,
        expect_error_contains=("must match",),
    ...
    Frame(
        ...
        1,
        "A1",
        "65-char name is too long",
        model_call="parse_group",
        model_input={"name": "a" * 65, "members": []},
        expect_ok=False,
        expect_error_contains=("must match",),
    ),
    Frame(
        ...
        1,
        "A1",
        "absent name is a type error, not a regex miss",
        model_call="parse_group",
        model_input={"members": []},
        expect_ok=False,
        expect_error_contains=("name must be a string",),
    ),
    Frame(
        "NAME-04.a",
        1,
        "A1",
        "non-string name (int) is a type error",
        model_call="parse_group",
        model_input={"name": 123, "members": []},
        expect_ok=False,
        expect_error_contains=("name must be a string, got 123",),
    ),
    ...
    Frame(
        ...
        1,
        "A6",
        "egress null is the remove-all guidance error",
        model_call="parse_rules_file",
    ...
    Frame(
        ...
        1,
        "A6",
        "non-list section (bare string) is rejected",
        model_call="parse_rules_file",
    ...
    Frame(
        ...
        1,
        "A6",
        "non-mapping rule entry is rejected",
        model_call="parse_rules_file",
        model_input={"security_group": "x", "ingress": [80]},
        expect_ok=False,
        expect_error_contains=("rule must be a mapping",),
    ),
    ...
    Frame(
        ...
        model_call="parse_remote",
        model_input="",
        expect_ok=False,
        expect_error_contains=("empty remote",),
    ),
    Frame(
        "REMOTE-06.a",
        1,
        "A7",
        "whitespace-only remote is rejected",
        model_call="parse_remote",
        model_input=" ",
        expect_ok=False,
        expect_error_contains=("empty remote",),
    ...
    Frame(
        ...
        1,
        "A7",
        "garbage with a slash is not a CIDR",
        model_call="parse_remote",
        model_input="tcp/80",
        expect_ok=False,
        expect_error_contains=("tcp/80",),
    ),
    Frame(
        "REMOTE-07.a",
        1,
        "A7",
        "rules entry without a source is rejected",
        model_call="parse_rules_file",
        model_input={"security_group": "x", "ingress": [{}]},
        expect_ok=False,
        expect_error_contains=("source is required",),
    ),
    Frame(
        "REMOTE-07.b",
        1,
    ...
    Frame(
        ...
        1,
        "A8",
        "icmpv6 is valid and portless",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [{"source": "0.0.0.0/0", "protocol": "icmpv6"}],
        },
        expect_ok=True,
        expect_value={
            "sg": "x",
    ...
    Frame(
        ...
        1,
        "A8",
        "all is valid and portless",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [{"source": "0.0.0.0/0", "protocol": "all"}],
        },
        expect_ok=True,
        expect_value={
            "sg": "x",
    ...
    Frame(
        ...
        model_input="http",
        expect_ok=False,
        expect_error_contains=("bad port",),
    ),
    Frame(
        "PORTS-06.a",
        1,
        "A9",
        "bool is a type error, not 0/1",
        model_call="parse_ports",
        model_input=True,
        expect_ok=False,
        expect_error_contains=("got bool",),
    ),
    Frame(
        "PORTS-06.b",
        1,
        ...
        model_input=80.5,
        expect_ok=False,
        expect_error_contains=("got float",),
    ),
    Frame(
        "PORTS-06.c",
        1,
        "A9",
        "empty entry inside the list is junk",
        model_call="parse_ports",
        model_input="80,,443",
        expect_ok=False,
        expect_error_contains=("empty entry",),
    ),
    Frame(
        "PORTS-06.d",
        1,
        "A9",
        "negative number parses as a reversed range",
        model_call="parse_ports",
        model_input="-1",
        expect_ok=False,
        expect_error_contains=("bad port range",),
    ),
    Frame(
        "PORTS-06.e",
        1,
        "A9",
        "unicode digit forms are junk",
        model_call="parse_ports",
        model_input="⁸⁰",
        expect_ok=False,
        expect_error_contains=("bad port",),
    ...
    Frame(
        ...
        1,
        "A10",
        "icmpv6 with ports is rejected",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [{"source": "a", "protocol": "icmpv6", "ports": "80"}],
        },
        expect_ok=False,
        expect_error_contains=("icmpv6 rules must not have ports",),
    ),
    Frame(
        "PP-03",
        1,
        "A10",
        "icmp with empty-string ports is portless",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [{"source": "a", "protocol": "icmp", "ports": ""}],
        },
        expect_ok=True,
        expect_value={
            "sg": "x",
    ...
    Frame(
        ...
        1,
        "A10",
        "icmpv6 with empty-list ports is portless",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [{"source": "a", "protocol": "icmpv6", "ports": []}],
        },
        expect_ok=True,
        expect_value={
            "sg": "x",
    ...
    Frame(
        ...
        1,
        "A10",
        "all without a ports key is portless",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [{"source": "a", "protocol": "all"}],
        },
        expect_ok=True,
        expect_value={
            "sg": "x",
    ...
    Frame(
        ...
        cloud={
            "nics": [
                {"port_id": "p1", "ip": "10.0.1.10", "vm": "vm-a"},
                {"port_id": "p2", "ip": "10.0.1.10"},
            ]
        },
        expect_ok=False,
        expect_error_contains=("matches multiple NICs", "vm=vm-a"),
        expect_overlaps=(),
    ),  # constraint 2: multi-match exits `nics`
    ...
    Frame(
        ...
        expect_actions=(
            ("+", "group", "web"),
            ("+", "rule", "web", "ingress icmp all from cidr:0.0.0.0/0"),
        ),
        expect_unmanaged=(),
    ),
    ...
    Frame(
        ...
        **_cli(
            ...
            expect_rc=1,
            expect_out=("1 throttled", "re-run to resume"),
        ),
    ),
    Frame(
        "CLI-16",
    ...
    Frame(
        ...
        3,
        "A20",
        "numeric SERVICE_CALL_BUDGET is honored",
        model_call="load_config",
        env={"SERVICE_CALL_BUDGET": "40"},
    ...
    Frame(
        ...
        3,
        "A20",
        "budget 0 is a valid (pessimistic) value",
        model_call="load_config",
        env={"SERVICE_CALL_BUDGET": "0"},
    ...
    Frame(
        ...
        3,
        "A20",
        "SSL_VERIFY=false disables verification",
        model_call="load_config",
    ...
    Frame(
        ...
        3,
        "A20",
        "SSL_VERIFY unset verifies by default",
        model_call="load_config",
        env={"SSL_VERIFY": None},
    ...
    Frame(
        ...
        3,
        "A20",
        "CA_BUNDLE feeds the config verbatim",
        model_call="load_config",
        env={"CA_BUNDLE": "/tmp/ca.pem"},
    ...
    Frame(
        ...
        1,
        "A1",
        "typical hyphenated name is valid",
        model_call="parse_group",
        model_input={
            "name": "web-tier",
            "description": "web",
    ...
    Frame(
        ...
        1,
        "A1",
        "IP-lookalike name is rejected first",
        model_call="parse_group",
        model_input={"name": "10.0.1.10", "members": []},
        expect_ok=False,
        expect_error_contains=("must not look like an IP/CIDR",),
    ),
    Frame(
        "NAME-03.a",
        1,
        "A1",
        "CIDR-lookalike name is rejected first",
        model_call="parse_group",
        model_input={"name": "10.0.0.0/8", "members": []},
        expect_ok=False,
        expect_error_contains=("must not look like an IP/CIDR",),
    ),
    Frame(
    ...
    Frame(
        ...
        1,
        "A2",
        "empty-string description stays empty",
        model_call="parse_group",
        model_input={"name": "web", "description": ""},
        expect_ok=True,
        expect_value=("web", "", ()),
    ),
    Frame(
        ...
        model_call="parse_group",
        model_input={"name": "web", "description": 5},
        expect_ok=False,
        expect_error_contains=("description must be a string",),
    ),
    Frame(
        "MEMB-01",
        1,
        "A3",
        "absent members defaults to empty",
        model_call="parse_group",
        model_input={"name": "web"},
        expect_ok=True,
        expect_value=("web", "", ()),
    ...
    Frame(
        ...
        1,
        "A3",
        "non-list members is rejected",
        model_call="parse_group",
        model_input={"name": "web", "members": "10.0.1.10"},
        expect_ok=False,
        expect_error_contains=("members must be a list",),
    ),
    Frame(
        "MIP-01",
        1,
        "A4",
        "mapping with a valid ip is the happy member",
        model_call="parse_group",
        model_input={"name": "g", "members": [{"ip": "10.0.1.10"}]},
        expect_ok=True,
        expect_value=("g", "", ("10.0.1.10",)),
    ),
    Frame(
        "MIP-02",
        1,
        "A4",
        "extra keys in a member entry are tolerated",
        model_call="parse_group",
        model_input={
            "name": "g",
    ...
    Frame(
        ...
        1,
        "A4",
        "bare-string member entry is rejected",
        model_call="parse_group",
        model_input={"name": "g", "members": ["10.0.1.10"]},
        expect_ok=False,
    ...
    Frame(
        ...
        1,
        "A4",
        "member mapping without ip is rejected",
        model_call="parse_group",
        model_input={"name": "g", "members": [{}]},
        expect_ok=False,
        expect_error_contains=("member must be a mapping with an 'ip' key",),
    ),
    Frame(
        ...
        model_call="parse_group",
        model_input={"name": "g", "members": [{"ip": 10}]},
        expect_ok=False,
        expect_error_contains=("ip must be a string",),
    ),
    Frame(
        "MIP-05.a",
        1,
        "A4",
        "out-of-range ip is rejected",
        model_call="parse_group",
        model_input={"name": "g", "members": [{"ip": "999.0.0.1"}]},
        expect_ok=False,
        expect_error_contains=("is not a valid address",),
    ),
    Frame(
        "MIP-05.b",
        1,
        "A4",
        "leading-zero ip spelling is rejected",
        model_call="parse_group",
    ...
    Frame(
        ...
        1,
        "A4",
        "IPv6 member ip is not supported",
        model_call="parse_group",
        model_input={"name": "g", "members": [{"ip": "::1"}]},
        expect_ok=False,
        expect_error_contains=("IPv6",),
    ),
    Frame(
        "MIP-06",
        1,
        "A4",
        "duplicate member ip (address-based) is rejected",
        model_call="parse_group",
        model_input={
            "name": "g",
        ...
        expect_ok=False,
        expect_error_contains=("duplicate ip",),
    ),
    Frame(
        "SGF-01",
        1,
        "A5",
        "typical security_group is valid",
        model_call="parse_rules_file",
        model_input={
            "security_group": "app-tier",
            "ingress": [
    ...
    Frame(
        ...
        1,
        "A6",
        "present sections parse their rules",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [
            ...
            "egress": [
                {"destination": "db", "protocol": "tcp", "ports": [5432]}
            ],
        },
        expect_ok=True,
        expect_value={
    ...
    Frame(
        ...
        1,
        "A6",
        "empty list means managed remove-all",
        model_call="parse_rules_file",
        model_input={"security_group": "x", "ingress": []},
        expect_ok=True,
        expect_value={
    ...
    Frame(
        ...
        1,
        "A6",
        "absent section means unmanaged",
        model_call="parse_rules_file",
    ...
    Frame(
        ...
        1,
        "A6",
        "ingress null is the remove-all guidance error",
        model_call="parse_rules_file",
    ...
    Frame(
        ...
        1,
        "A7",
        "plain name is a group remote",
        model_call="parse_remote",
        model_input="web-tier",
        expect_ok=True,
        expect_value=("group", "web-tier"),
    ),
    Frame(
        "REMOTE-02",
        1,
        "A7",
        "slash form is a CIDR remote",
        model_call="parse_remote",
        model_input="10.0.0.0/8",
        expect_ok=True,
        expect_value=("cidr", "10.0.0.0/8"),
    ),
    Frame(
        "REMOTE-02.a",
        1,
        "A7",
        "the any-remote CIDR is valid",
        model_call="parse_remote",
        model_input="0.0.0.0/0",
        expect_ok=True,
        expect_value=("cidr", "0.0.0.0/0"),
    ),
    Frame(
        "REMOTE-03.a",
        1,
        "A7",
        "bare ip normalises to /32",
        model_call="parse_remote",
        model_input="203.0.113.7",
        expect_ok=True,
        expect_value=("cidr", "203.0.113.7/32"),
    ),
    Frame(
        "REMOTE-03.b",
        1,
    ...
    Frame(
        ...
        1,
        "A7",
        "invalid prefix length raises",
        model_call="parse_remote",
        model_input="10.0.0.0/99",
        expect_ok=False,
        expect_error_contains=("10.0.0.0/99",),
    ),
    Frame(
        "REMOTE-05",
        1,
    ...
    Frame(
        ...
        1,
        "A8",
        "unknown protocol is rejected with the list",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [{"source": "a", "protocol": "sctp"}],
        },
        expect_ok=False,
        expect_error_contains=("protocol must be one of",),
    ),
    Frame(
        "PROTO-02.a",
        1,
        "A8",
        "absent protocol is rejected",
        model_call="parse_rules_file",
    ...
    Frame(
        ...
        model_call="parse_ports",
        model_input="8000-9000",
        expect_ok=True,
        expect_value="8000-9000",
    ),
    Frame(
        "PORTS-02.a",
        1,
        ...
        model_call="parse_ports",
        model_input="80,443,8000-9000",
        expect_ok=True,
        expect_value="80,443,8000-9000",
    ),
    Frame(
        "PORTS-03",
        1,
    ...
    Frame(
        ...
        1,
        "A9",
        "adjacent ports merge into a range",
        model_call="parse_ports",
        model_input="80,81,82",
        expect_ok=True,
        expect_value="80-82",
    ),
    Frame(
    ...
    Frame(
        ...
        1,
        "A9",
        "spaces around entries are tolerated",
        model_call="parse_ports",
        model_input="80, 443",
        expect_ok=True,
        expect_value="80,443",
    ...
    Frame(
        ...
        1,
        "A9",
        "port 0 is out of bounds",
        model_call="parse_ports",
        model_input="0",
        expect_ok=False,
        expect_error_contains=("out of range",),
    ),
    Frame(
        "PORTS-05.a",
        1,
        "A9",
        "port 65536 is out of bounds",
        model_call="parse_ports",
        model_input="65536",
        expect_ok=False,
        expect_error_contains=("out of range",),
    ...
    Frame(
        ...
        model_call="parse_ports",
        model_input="9000-8000",
        expect_ok=False,
        expect_error_contains=("reversed range",),
    ),
    Frame(
        "PORTS-07",
        1,
        ...
        expect_ok=False,
        expect_error_contains=("at most 20",),
    ),
    Frame(
        "PORTS-07.a",
        1,
        "A9",
        "20 adjacent ports merge to 1-20",
        model_call="parse_ports",
    ...
    Frame(
        ...
        1,
        "A9",
        "the full range means all ports",
        model_call="parse_ports",
        model_input="1-65535",
        expect_ok=True,
        expect_value=None,
    ...
    Frame(
        ...
        1,
        "A9",
        "split full range still means all ports",
        model_call="parse_ports",
        model_input="1-100,101-65535",
        expect_ok=True,
        expect_value=None,
    ),
    Frame(
        ...
        1,
        "A10",
        "icmp with ports is rejected",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [{"source": "a", "protocol": "icmp", "ports": "80"}],
        },
        expect_ok=False,
        expect_error_contains=("icmp rules must not have ports",),
    ),
    Frame(
        "PP-02.a",
        1,
        "A10",
        "all with ports is rejected",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [{"source": "a", "protocol": "all", "ports": "80"}],
        },
        expect_ok=False,
        expect_error_contains=("all rules must not have ports",),
    ),
    Frame(
        "DUPRULE-01",
        1,
        "A11",
        "exact duplicate rule identity is rejected",
        model_call="parse_rules_file",
        model_input={
            "security_group": "x",
            "ingress": [
    ...
    Frame(
        ...
        1,
        "A19",
        "summary counts signs across payload kinds",
    ...
    Frame(
        ...
        1,
        "A19",
        "empty ActionList summarizes to zeros",
        model_call="actionlist_summary",
        model_input={"actions": []},
    ...
    Frame(
        ...
        1,
        "A19",
        "DesiredState is a plain container",
        model_call="desired_state",
        model_input={"groups": ["a"], "rules": ["a"]},
        expect_ok=True,
    ),
    ...
    Frame(
        ...
        expect_ok=False,
        expect_error_contains=("matches multiple NICs",),
    ),
    Frame(
        "RES-04",
        2,
    ...
    Frame(
        ...
        cloud={"nics": [{"port_id": "p1", "ip": "10.0.1.10"}]},
        expect_ok=False,
        expect_error_contains=("10.0.9.99",),
        expect_nics=(("10.0.1.10", "p1"),),
    ),
    Frame(
        "RATE-01",
        2,
        "A22",
        "budget allows N then blocks",
        usecase="ratelimit",
        model_input={
            "budget": 3,
            "window": 300,
            "ops": [("acquire",), ("acquire",), ("acquire",), ("acquire",)],
        },
    ...
    Frame(
        ...
        2,
        "A22",
        "external throttle halves the limit",
        usecase="ratelimit",
        model_input={
            "budget": 10,
            "window": 300,
    ...
    Frame(
        ...
        2,
        "A23",
        "wire min/max translate to a port range",
        usecase="translate_rule",
        model_input={
            "id": "r1",
            "sg": "sg1",
    ...
    Frame(
        ...
        2,
        "A24",
        "writer round-trip: create, update, delete",
        usecase="fake",
        model_input=(
            ("create_sg", "web", "d"),
    ...
    Frame(
        ...
        expect_actions=(),
        expect_unmanaged=(
            "ingress rules of y (1 cloud rules untouched)",
    ...
    Frame(
        ...
        expect_clears=("egress rules of v6",),
        expect_unmanaged=(),
    ),
    Frame(
        "PLAN-16",
        ...
        expect_error_contains=(
            "duplicate cloud security group name",
            "'web' (sg-a, sg-b)",
        ),
    ),
    Frame(
    ...
    Frame(
        ...
        cloud={
            "sgs": [
                {"id": "sg-web", "name": "web", "description": "a"},
    ...
    Frame(
        ...
        3,
        "A20",
        "--yes writes audit.jsonl in the project",
        **_cli(
            argv=["apply", "--yes"], expect_rc=0, expect_files=("audit.jsonl",)
        ),
    ),
    Frame(
        "CLI-20",
    ...
    Frame(
        ...
        3,
        "A20",
        "every command logs the same phase verbs under --verbose "
        "(import shown: offline, phases only, no gateway calls)",
    ...
    Frame(
        ...
        cloud={"nics": [{"port_id": "p1", "ip": "10.0.1.10"}]},
        argv=["drift", "--snapshot", "snapshot.json"],
        expect_rc=1,
    ...
    Frame(
        ...
        argv=["drift", "--json"],
        expect_rc=1,  # auto snapshot.json
        expect_out=(
            '"diff"',
            '"missingObjects"',
            '"unexpectedObjects"',
    ...
    Frame(
        ...
        cloud={
            "sgs": [
                {"id": "sg-web", "name": "web", "description": "d"},
                {"id": "sg-db", "name": "db"},
            ],
            "rules": [
                {
        ...
        expect_value={
            ...
            "rules": {
                "web": [("ingress", "tcp", "22", ("cidr", "203.0.113.0/24"))],
                "db": [("egress", "all", None, ("group", "web"))],
            },
    ...
    Frame(
        ...
        usecase="import",
        expect_value={
            "groups": ["app", "dup"],  # first dup id kept
            "rules": {"app": [], "dup": []},
    ...
    Frame(
        ...
        expect_value={
            "groups": ["ok"],
            "rules": {"ok": []},
            "notes": ("cannot become a config file", "not a v4 CIDR"),
        },
    ),
    Frame(
        "IMP-03.a",
        ...
        expect_value={
            "groups": ["app"],
            "rules": {
                "app": [("ingress", "tcp", "80", ("cidr", "0.0.0.0/0"))]
            },
            "notes": (),
        },
    ),
